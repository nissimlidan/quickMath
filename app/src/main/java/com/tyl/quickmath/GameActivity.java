...
public class GameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        answerLayoutP1 = findViewById(R.id.answersButtonsLayout1);
        answerLayoutP2 = findViewById(R.id.answersButtonsLayout2);
...
//        showView(labelsP2);
        if(!tieScore) {
            ...
            handler.postDelayed(new Runnable() {
                ...
                public void run() {
                    isActive = true;
                    gifImageView.setVisibility(View.GONE);//set game state to active
...
//
        ...
        // You can modify the duration here
